...
nyt_task3_2 <- nyt_task3_1 %>% select(!c(fips, deaths, population)) %>%
  ...
  mutate(avg_cases_group = ceiling(avg_cases/15),
         avg_cases_group = ifelse(avg_cases_group > 10 & avg_cases_group <= 25, 
                                  11, avg_cases_group),
         avg_cases_group = ifelse(avg_cases_group > 25, 12, avg_cases_group),
          avg_cases_group = ifelse(avg_cases_group <= 0 | 
                                     is.na(avg_cases_group), 0, avg_cases_group)#,
         #avg_cases_group = as.factor(avg_cases_group)
         ) 
